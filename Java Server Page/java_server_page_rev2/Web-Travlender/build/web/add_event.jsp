        ...
        <div class = add_activity>
          <h2>Add Activity</h2>
            ...
            <select name="location" >
                  <option value="rmhCGK">Rumah - Bandara Soekarno Hatta</option>
                  <option value="ftwTgr">Fatmawati - Tangerang</option>
                  <option value="cgkHll">Bandara Soekarno Hatta Tangerang - Bandara Haluoleo Kadia</option>
                  <option value="htlRest">Hotel X Kadia - Restoran Poasia</option>
              </select>
            <br><br>
