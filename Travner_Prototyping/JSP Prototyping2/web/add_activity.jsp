<%-- 
    ...
    Created on : Dec 19, 2017, 12:39:33 AM
    Author     : netspy
--%>
		  ...
		  <div id='calendar'></div>
            ...
            <div class="right">
                ...
                <div class="tab">
                    ...
                    <p>End time:</p>
                    <p><input type="date" name="day"><input type="time" name="time"></p><br>
                    <p>Spare Time<p>
                    <p>
                    ...
                    <form name="form" action="" method="POST" id="geocoding_form">
                        ...
                        <p><input type="location" id="orig" size="50" name="orig" placeholder="Starting Position" />
                        ...
                        <p><input type="location" id="dest" size="50" name="dest" placeholder="Destinantion Location" />
