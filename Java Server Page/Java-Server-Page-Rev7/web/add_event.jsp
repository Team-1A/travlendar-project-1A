       ...
       <!-- <input class="add_button" type="submit" name="#" value="Add" >-->
        ...
        <div class = add_activity>
          <h2>Add Activity</h2>
            ...
            <input class="kotak_lo" type="text"  name="#" placeholder="What's on your mind?"><br>
          
            <span>Start Point</span><br>
            ...
            <span>What time does the activities started?</span><br>
            <input class="time" type="text"  name="#" placeholder="hour">
            <input class="time" type="text"  name="#" placeholder="minutes"><br>
          
            <span>What time does the activities ended?</span><br>
            <input class="time" type="text"  name="#" placeholder="hour">
            <input class="time" type="text"  name="#" placeholder="minutes"><br>
            
             <span>Priority Scale</span><br>
              <select name="Scale" >
