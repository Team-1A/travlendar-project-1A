                    ...
                    <div class="account-header">
                        ...
                        <div id="profile-details">
                            ...
                            <h2><c:out value="${sessionScope.email}" /><h2>
                                    ...
                                    <br>
                                    <div class="box">
                                        <h1 style="font-size: 30px; text-align: center; margin-top: 20px;">MY ACTIVITIES</h1>
                                        <table style="margin-top: 50px;">
                                            ...
                                            <tr>
                                                <td>Dies Natalis</td>
                                                <td>16/11/17  10.15 AM</td>
                                                <td>17/12/17  12.00 AM</td>
                                                <td>Villa Ziko</td>
                                                <td>12 KM</td>
                                                <td>45 mins</td>
                                                <td>Car</td>
                                                ...
                                                <td>10.00 AM</td>
                                                <td>
                                                    <button class="edit" style="background-color: #145A32;">Edit</button>
                                                    <button class="delete" style="background-color:#7B241C;">Delete</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
